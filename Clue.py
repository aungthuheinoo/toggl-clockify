...
class Clue:
    ...
    def syncTasks(self, workspace):
        ...
        tProjs = self.toggl.getWorkspaceProjects(workspace)  #change projects to getWorkspaceProjects(workspace)AT
        cProjs = self.clockify.getWorkspaceProjects(workspace) #change projects to getWorkspaceProjects(workspace)AT
    ...
    def syncProjects(self, workspace):
        ...
        for p in prjs:
            ...
            name = p["name"]
            #New Line added pID defined stage AT
